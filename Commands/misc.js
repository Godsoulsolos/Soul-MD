             ...
             switch (text.split(" ")[0]) {
                 case "on":
                     ...
                     if (!chatbott) {
                         ...
                         if (chatbott.worktype == "true") return citel.reply("Chatbot has successfully been enabled.")
                 ...
                 case "off":
                     ...
                     if (!chatbott) {
                         ...
                         if (chatbott.worktype == "false") return citel.reply("Chatbot has  successfully been disabled.")
